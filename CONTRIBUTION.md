...
Before opening an issue, please search the [issue tracker](https://github.com/oesukam/koodu/issues) to make sure your issue hasn’t already been reported.

## Development

Visit the [issue tracker](https://github.com/oesukam/koodu/issues) to find a list of open issues that need attention.

Fork, then clone the repo:

```
git clone https://github.com/oesukam/koodu.git
```
...
1. Open a new issue in the [Issue tracker](https://github.com/oesukam/koodu/issues)
1. Fork the repo
